...
class Risk(BaseModel):
    ...
    consequence: Optional[Consequence] = Field(
        None,
    ...
    description: Optional[str] = Field(
        None, description='The risk description in a natural language'
    )
    ...
    ] = Field(None, description='Array of URIs of the different Geospatial Data Layers')
    linkTo: Optional[
        List[
            Union[
                constr(
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI-LD Entity Type. It must be equal to Risk'
    )
