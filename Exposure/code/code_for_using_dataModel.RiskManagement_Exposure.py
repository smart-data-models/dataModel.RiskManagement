...
analysisType = "{'type': 'Property', 'value': 'Flood Exposure Maps'}"
...
createsLayers = {'type': 'Relationship', 'object': ['urn:ngsi-ld:EOGeoDataLayer:03', 'urn:ngsi-ld:EOGeoDataLayer:04']}
