...
dataModel = "NetworkServiceAlert"
subject = "dataModel.RiskManagement"
category = "{'type': 'Property', 'value': 'Network Service Scanning'}"
attribute = "category"
value = category
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

idCode = "{'type': 'Property', 'value': 'T1046 MITRE'}"
attribute = "idCode"
value = idCode
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

identify = {'type': 'Property', 'value': 'urn:ngsi-ld:Vulnerability:01'}
attribute = "identify"
value = identify
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
